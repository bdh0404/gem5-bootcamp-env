...
if __name__ == "__m5_main__":
    ...
    parser.add_argument("cpu_type", type=str,
        help="CPU type, options are atomic, timing")
    parser.add_argument("l1d_size", type=str,
        help="Size of L1 data cache, e.g. 16kB")
    parser.add_argument("--clk_freq", type=str, help="Clock Frequency",
        default="1GHz")
    ...
    processor = SimpleProcessor(cpu_type=cpu_type, isa=ISA.X86,
        num_cores=1)
    board = SimpleBoard(clk_freq=args.clk_freq, processor=processor,
        memory=memory, cache_hierarchy=cache_hierarchy)
