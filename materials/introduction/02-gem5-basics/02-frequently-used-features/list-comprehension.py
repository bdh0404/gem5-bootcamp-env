...
if __name__ == "__m5_main__":
    ...
    print("Example 2")
    processors = [SimpleProcessor(cpu_type=cpu, isa=ISA.X86, num_cores=1)
    ...
    print("Example 3")
    multi_core_processors = {cores: SimpleProcessor(cpu_type=CPUTypes.TIMING, 
        isa=ISA.X86, num_cores=cores) for cores in [1, 2, 4]}
    print("- Processor list:")
